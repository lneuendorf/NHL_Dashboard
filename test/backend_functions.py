...
if not engine.dialect.has_table(conn, "Team"):
    ...
    pd.read_csv('../hockey_data/Team.csv').to_sql('Team',con=engine,
                                                  if_exists='append',
                                                  index=False,
                                                  dtype={
...
if not engine.dialect.has_table(conn, "Player"):
    ...
    pd.read_csv('../hockey_data/Player.csv').to_sql('Player',con=engine,
                                                  if_exists='append',
                                                  index=False,
                                                  dtype={
                                                      'player_id': Integer,
...
if not engine.dialect.has_table(conn, "BasicStats"):
    ...
    pd.read_csv('../hockey_data/BasicStats.csv').to_sql('BasicStats',con=engine,
                                                  if_exists='append',
                                                  index=False,
                                                  dtype={
                                                      'player_id': Integer,
...
if not engine.dialect.has_table(conn, "AdvancedStats"):
    ...
    pd.read_csv('../hockey_data/AdvancedStats.csv').to_sql('AdvancedStats',con=engine,
                                                  if_exists='append',
                                                  index=False,
                                                  dtype={
                                                      'player_id': Integer,
